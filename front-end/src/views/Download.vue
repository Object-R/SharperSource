                        ...
                        <el-row :gutter="20">
                            ...
                            <el-col :span="10">
                                <el-form-item prop="local_file" :label="'Local_File'" label-width="40%" style="width: 100%"
                                    class="item">
                                    <el-input placeholder="" v-model="searchInfo.local_file" :disabled="true">
                                    </el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="10">
                                <el-form-item prop="remote_file" :label="'Remote_File'" label-width="40%" style="width: 100%"
                                    class="item">
                                    <el-input placeholder="Please input" v-model="searchInfo.remote_file" :disabled="false">
                                    </el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
...
export default {
    ...
    methods: {
        onSubmitBusiness() {
            ...
            let params = 'http://124.71.210.102:8082/global-back/download'
            ...
            this.axios.post(params,
                {
                    ...
                    "remote_file": this.searchInfo.remote_file,
                    "local_path": this.searchInfo.local_path,
                    "local_file": this.searchInfo.remote_file,
                },
                {
                    headers: {
